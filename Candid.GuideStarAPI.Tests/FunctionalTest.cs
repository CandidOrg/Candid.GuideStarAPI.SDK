...
namespace Candid.GuideStarAPI.Tests
{
  ...
  public class FunctionalTest
  {
    ...
    [Fact]
    public async void GuideStarEssentialsGetOrganizationAsyncWorks()
    {
      // return guidestar as search result.  expecting 200 result
      var payload = SearchPayloadBuilder.Create()
        .WithSearchTerms("guidestar")
    ...
    [Fact]
    public async void GuideStarEssentialsLookupAsyncWorks()
    {
      var lookup = await EssentialsResource.GetLookupAsync();
